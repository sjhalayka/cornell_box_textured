...
At each bounce, one takes into account the properties of the surface that are responsible for the bouncing, such as colour.
...
Each image is rendered at a size of 7680 x 4204, at $25$ samples per eye ray with maximum $n = 5$ bounces, then cropped and downsized to to like 1000 x 1000.
