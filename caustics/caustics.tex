...
In essence, instead of always using a pseudorandom cosine-weighted direction vector, refraction occurs for transparent objects.
Note that reflection caustics are created by reflective surfaces by default.
}
\end{figure}
