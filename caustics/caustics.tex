...
This method is in direct competition with photon mapping, given that they produce the same phenomena.
...
For a review of modern graphics programming techniques, please see the ageless \cite{pharr}.
...
This paper is in honour of Canadian tech companies like Softimage.
It was my impossible dream to own Softimage -- with mental ray -- and so now I've tried my best to emulate it.
