...
Images like these are an homage to Canadian 3D companies from the 1990s, such as Alias, ATI, Matrox, and Softimage (including the German mental ray renderer).
}
\end{figure}
