...
Say that $s = 25$, or some other large number, and where opacity equals $0.25$, then the probability of taking the refracted path is like $1 - 0.25 = 0.75$.
Reducing the opacity causes an increase in refracted light and a decrease in the reflected/scattered light, as intuited.
