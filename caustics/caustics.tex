...
\item Appendix B: Barrel light failure
\item Appendix C: Contemporary graphics research on caustics
\item Appendix D: Classical photon mapping
\end{itemize}
...
This particular issue does not plague the bidirectional or forward path tracers.
In backward path tracing we avoid this particular issue by simply refraining from using barrel lights to begin with.
