...
Comparing this backward path tracer to photon mapping is like comparing apples and oranges.
...
In essence, photon mapping is not natural when compared to the ease and naturalness of the caustics in the backward path tracer.
