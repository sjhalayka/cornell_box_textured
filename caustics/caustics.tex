...
\item Bidirectional or forward path tracers, and convergence problems
...
\section{Global illumination: photon mapping versus backward path tracer}
...
\section{Caustics: multiple modern implementations versus backward path tracer}
