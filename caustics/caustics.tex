...
\item Appendix A: contemporary graphics research with regard to caustics
\item Appendix B: photon mapping versus the new general backward path tracer
\end{itemize}
...
Essentially, each eye ray sample is bounced around (e.g. scattered) pseudorandomly as it hits surfaces within the scene.
...
\section{Caustics especially: multiple modern approaches versus backward path tracer}

We should also consider the work of others, in regard to caustics.
...
\section{Global illumination in general: photon mapping versus backward path tracer}
