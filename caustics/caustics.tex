...
To be fair, there is at least one lighting setup that cannot be modeled by using backward path tracing.
...
\centering
  ...
  \caption{ Barrel light using the backward path tracer.
