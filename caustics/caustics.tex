...
See Fig. 11.
We shall work at implementing importance sampling with the backward path tracer, which is likely the easiest -- and the most natural -- solution to the barrel light setup.
Let this paper serve as a stepping stone toward that goal.
...
We consider this to be a failure of the backward path tracer on its own.
}
\end{figure}
