...
void vkglTF::Model::loadImages(std::vector<tinygltf::Image>& gltfimages, tinygltf::Model& gltfModel, vks::VulkanDevice* device, VkQueue transferQueue)
{
...
void vkglTF::Model::loadFromFile(
	...
	std::string filename, vks::VulkanDevice* device, VkQueue transferQueue, uint32_t fileLoadingFlags, float scale)
{
	indexBuffer.clear();
	vertexBuffer.clear();
	gltfimages.clear();
